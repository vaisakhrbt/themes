				...
				<div class="box-info-product">
					...
					<div class="product_attributes clearfix">
					   ...
					   <div class="box-cart-bottom">
					 	<div class="bt-addcart-a" {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
							<p id="add_to_cart" class="buttons_bottom_block no-print">
								<button type="submit" name="Submit" class="btcartdetail">
			                        ...
			                        {/if}                  
                                                <div class="bt-otheres-a">{if isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS}{$HOOK_PRODUCT_ACTIONS}{/if}<strong></strong>
                                                </div>
                                               <div class="bt-compare-a">
                                                   <a href="#" class="list-group-item"><i class="fa fa-refresh"></i> COMPARE TO OTHERS</a>
                                               </div>
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
    ...
    <ul class="nav nav-tabs " role="tablist">
        <li class="active"><a href="#tab2" role="tab" data-toggle="tab">More info </a></li>
        <li ><a href="#tab3" role="tab" data-toggle="tab">Data sheet </a></li>
        <li><a href="#tab6" role="tab" data-toggle="tab">REVIEWS </a></li>
									...
									<li class="item product-box ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
										...
										<div class="clearfix" style="margin-top:5px">
											{if !$PS_CATALOG_MODE && ($accessory.allow_oosp || $accessory.quantity > 0)}
												<div class="no-print">
													<a class="exclusive button ajax_add_to_cart_button" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$accessory.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product|intval}" title="{l s='ADD CART'}">
														<span>{l s='ADD CART'}</span>
													</a>
												</div>
											{/if}
										</div>
