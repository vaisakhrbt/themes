...
{/if}
		...
		<![endif]-->
		<link rel="stylesheet" type="text/css" href="themes/electronics/css/responsive.css" />
			...
			<div class="header-container">
				<header id="header">
                                  <div class="top-head">
                                    <div class="container">
                                                    <div class="row">
                                                          <div class="col-sm-4 float-none-repo">
                                                                 <div class="floatleft float-right-repons"> 
                                                                      {hook h="displayNav" mod="blocklanguages"}
                                                                 </div>
                                                                <div class="floatleft float-right-repons"> 
                                                                      {hook h="displayNav" mod="blockcurrencies"}
                                                                 </div>
                                                                 
                                                          </div>
                                                         <div class="col-sm-8 float-none-repo">
                                                              ...
                                                              <div class="floatleft"> 
                                                                 ...
                                                                 <div class="floatleft"> 
                                                                  <a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" 
                                                                           title="{l s='My account' mod='blockmyaccount'}">
										{l s='My account' mod='blockmyaccount'}
									</a>
                                                                 </div>
                                                                
                                                                <div class="floatleft"> 
                                                                   {hook h="displayMyAccountBlock" mod="blockwishlist"}
                                                                 </div>
                                                              </div>
                                                            </div>
										...
										<img class="logo img-responsive" src="{$logo_url}" alt="{$shop_name|escape:'html':'UTF-8'}" />
                                                               ...
                                                               <div class="col-sm-8">
                                                                  <div class="floatright">
                                                                   {hook h="top" mod="blockcart" }
                                                                 </div>
                                                                 <div class="floatright">
                                                                   {hook h="top" mod="blocksearch" }
                                                                 </div> 
			...
			<div class="columns-container">
				<div id="columns" class="container">
					...
					<div id="slider_row" class="row">
						<div id="top_column" class="center_column col-xs-8 col-sm-12">
                                                  {hook h="displayTopColumn"}
                                                </div>
                                                <div id="top_column" class="center_column col-xs-4 col-sm-12">
                                                {if $page_name =='index' }  {hook h="home" mod="blockcmsinfo"}{/if}
                                                </div>
					</div>
					<div class="row">
						{if isset($left_column_size) && !empty($left_column_size)}
                                                        <div id="left_column" class="column col-left-news  col-xs-12 col-sm-{$left_column_size|intval}">
